...
public class GetDesignTaskListQuery : IRequest<IEnumerable<DesignTagDTO>>
{
    public Guid DesignTemplateId { get; init; }

    public class GetDesignTaskListQueryHandler : IRequestHandler<GetDesignTaskListQuery, IEnumerable<DesignTagDTO>>
    {
        ...
        public async Task<IEnumerable<DesignTagDTO>> Handle(GetDesignTaskListQuery request, CancellationToken cancellationToken)
        {
